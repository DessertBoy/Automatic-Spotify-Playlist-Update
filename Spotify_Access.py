...
"""Creating a class with a method to automate the token refreshing process"""
...
class SpotifyAccess:
	...
	def retrieve_token(self,url):
		...
		#playlist_modify_private is the name of the scope we are going to use on Spotify.
