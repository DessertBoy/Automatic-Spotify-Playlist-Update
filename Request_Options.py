...
class Request_Methods:
	...
	def get(url,headers = None,paramaters = None):
		...
		param: Paramaters specifying what we want from the get request. For retrieving songs from our playlist the paramaters will be the limit of the songs we want back.
